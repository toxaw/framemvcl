...
<div class="container">
    <div class="row">
       <div class="page-header">
        <h1><small>Добавление цели</small></h1>
      </div>
    </div> 
    <div class="row">
       <form class="form-horizontal" role="form">
        <div class="form-group">
          <label for="input-id" class="col-sm-2 control-label">ID цели (9 цифр)</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" id="input-id" placeholder="ID цели" pattern="[0-9]{9}" required>
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <div class="col-sm-offset-2 col-sm-10">
            <div class="alert alert-danger" role="alert">Ошибка: цель уже существует!</div>
          </div>
        </div>
        <div class="form-group">
          <div class="col-sm-offset-2 col-sm-10">
            <button type="submit" class="btn btn-default">Добавить цель</button>
          </div>
        </div>
       </form>      
    </div> 
